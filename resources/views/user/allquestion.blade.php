             ...
             <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="row">
                        <div class="col-lg-4 col-md-4">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img src="{{asset('frontend/img/onlineshop.png')}}" style="height: 150px" alt="">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img src="{{asset('frontend/img/foodpanda_website_redesign_4x.png')}}" style="height: 150px" alt="">
                                </div>
                                <div class="program__content">
                                    <span>Website</span>
                                    <h4>What is Website?</h4>
                ...
                <div class="col-lg-12">
                    <div class="course_all_btn text-center">
                        <a href="/onequestion" class="boxed-btn4">View All</a>
                    </div>
                </div>
            </div>
