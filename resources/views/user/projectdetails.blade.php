...
<div class="bradcam_area breadcam_bg">
  ...
  <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section_title text-center" name="projectcategory">
         ...
         <div class="row">
            <div class="col-lg-9 posts-list">
               <div class="single-post">
                  <div class="feature-img" name="projectimage">
                 ...
                 <div class="d-flex align-items-center">
                  ...
                  <div class="blog_details" name="projectname">
                     <h2>How To Make a website step by step
                     </h2>
                     
                     <p class="excert" name="projectdetails">
